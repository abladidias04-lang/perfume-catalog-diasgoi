...
export default function Home() {
  ...
  // ЖАҢА: Себетті (localStorage) арқылы сақтау
  ...
  // ЖАҢА: Себет өзгерген сайын оны жадқа сақтаймыз
  useEffect(() => {
  ...
  // ЖАҢА: Брендтердегі қайталануды (Boss, BOSS, Boss ) болдырмау үшін ақылды тазалау
  ...
  const filteredPerfumes = perfumes.filter(perfume => {
    ...
    // ЖАҢА: Брендтерді іздеу кезінде де қатесіз табу үшін кіші әріппен салыстырамыз
